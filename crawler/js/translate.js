(function() {
  ...
  function performTranslation() {
    ...
    var gtTimeInfo = {'fetchStart': new Date().getTime() - 100 - Math.floor(Math.random() * 100), 'fetchEnd': new Date().getTime()};
    var serverParams = '';
    ...
    try {  (function(){var gtConstEvalStartTime = new Date();/*
    ...
    */
    ...
    if (_isNS('google.translate.Element')){return}(function(){var c=_setupNS('google.translate._const');c._cest = gtConstEvalStartTime;gtConstEvalStartTime = undefined;c._cl='en';c._cuc='cr.googleTranslate.onTranslateElementLoad';c._cac='';c._cam='lib';c._cjlc=cr.googleTranslate.onLoadJavascript;c._ctkk='442416.1587460458';var h='translate.googleapis.com';var s=(true?'https':window.location.protocol=='https:'?'https':'http')+'://';var b=s+h;c._pah=h;c._pas=s;c._pbi=b+'/translate_static/img/te_bk.gif';c._pci=b+'/translate_static/img/te_ctrl3.gif';c._pli=b+'/translate_static/img/loading.gif';c._plla=h+'/translate_a/l';c._pmi=b+'/translate_static/img/mini_google.png';c._ps=b+'/translate_static/css/translateelement.css';c._puh='translate.google.com';cr.googleTranslate.onLoadCSS(c._ps);c._cjlc(b+'/translate_static/js/element/main.js');})();})();;} catch (error) {  cr.googleTranslate.onTranslateElementError(error);};

    cr.googleTranslate.readyCallback = function() {
      cr.googleTranslate.translate('', 'en');
    }
    window.cr = cr;
  }
  ...
  // window.addEventListener('___performTranslation', performTranslation);

  // var actualCode = '(' + function() {
  //   // ensure that they won't get changed by the page
  //   let CustomEvent = window.CustomEvent;
  //   let dispatchEvent = window.dispatchEvent;
  //   window.___translatePage = function() {
  //     dispatchEvent(new CustomEvent('___performTranslation'));
  //   }
  // } + ')();';
